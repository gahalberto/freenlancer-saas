...
export const finishService = async (id: string, amount: number) => {
  ...
  const total_to_pay = amount + service.mashguiachPrice
  ...
  await db.notification.create({
    data: {
      message: `Chegou R$ ${amount} na sua carteira, do seu trabalho no evento ${serviceInfo.StoreEvents.title} localizado em ${serviceInfo.StoreEvents.address_street}.`,
